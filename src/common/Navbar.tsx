  ...
  return (
    <div>
              ...
              <div className="container-fluid">
                ...
                <div className="collapse navbar-collapse" id="navbarScroll">
                  ...
                  <div className="header-shop-btns">
                    <button
                      type="button"
                      className="notification resp-hidden"
      ...
      <div className="bottom-nav">
        {pathname.includes("/competition/details") && (
        ...
        <div className="bottom-nav">
          <div className="bottom-nav-all">
            <div className="bottom-nav-responsive-three">
              <button type="button" className="bottom-nav-res">
                <svg
                  width={33}
                  height={19}
                  viewBox="0 0 33 19"
